    ...
    <>
      ...
      <Container>
        ...
        <p>
          ...
          Mahaparinirvana he emphasized what he had been telling many of his
          close disciples for the last few years: the most important activity we
          can engage in to help dispel imminent global obstacles to peace and
          harmony, as well as environmental problems and instability, is to
          accumulate the recitation of the Seven Line Prayer, the most powerful
          invocation to Padmasambhava. At the time when Rinpoche last spoke of
          this in early 2018, he increased the goal he had set for us from one
          billion Seven Line Prayers to twenty one billion! The implication was
          that the negative potentials had gained so much momentum that it would
          require this immense number to turn the tide. Clearly this will
          require a global effort. The current count is only at about seven
          million so we have a long way to go. (Note for Europeans: this refers
          to an American billion, not a European billion) So let’s do our
          personal accumulations as we also collaborate with others and inspire
          them to join us in this important effort.
        </p>
        <p>
        ...
        <p>
          ...
          dakinis sang this tribute in one voice as a praise to the Lotus-born
          Guru. These dakinis chanted this from three most sacred places.
          Therefore, it has great blessings.
        </p>
        <p>
        ...
        <p>
          ...
          to him asking for teachings, he would simply say: "Just recite this
          prayer, and while doing so, have heartfelt devotion. Recite this, that
          is enough". Therefore, my own root teacher himself essentialized all
