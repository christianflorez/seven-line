...
function Guidelines() {
  return (
    <>
      <Container>
        <S.MainHeader>
          Guidelines and tips on how to accumulate and when to submit:
        </S.MainHeader>
        <p>
        ...
        <p>
          If you’ve accumulated a number of Seven-Line Prayers prior to learning
          about this accumulation you can add them to this global count, as long
          as you recited them after the start of 2017 when we began this
          initiative. Please don’t add any accumulations from before the year
          2017.
        </p>
        <p>
          If you are accumulating Seven-Line Prayers as part of another
          accumulation initiative, at the instructions of your own Lama, or
          dedicating them for the well being of a loved one, etc. then you can
          still include them in this global accumulation count! There is no
          conflict: the only condition is that you’ve recited them no earlier
          than the year 2017.
        </p>
        <p>
        ...
        <p>
          <b>Thank you for joining us in this vast field of merit!</b>
        </p>
      </Container>
    </>
  );
